<?php
    ...
    $bookings = [];
    $bookingQuerry = "SELECT * FROM bookings Where status = 'Checked In' Order By id desc";
                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Cheked In</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">checked In</h1> 
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    <?php foreach( $bookings as $row): ?>
                                        <tr>
                                            ...
                                            <td class="conts">
                                                <a class="a1" href="backend/checkout.php?id=<?= $row['id'] ?>"><span class="badge bg-danger">Check Out</span></a>
                                                <div class="tipm">When clicked. This row will be moved in the checked-out page and will be recognized as a checked-out individual.</div>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
